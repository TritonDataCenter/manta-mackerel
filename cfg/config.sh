...
STORAGE_REDUCE_CMD_DAILY=$AVG_COLUMNS
STORAGE_REDUCE_CMD_MONTHLY=$AVG_COLUMNS
...
STORAGE_NUM_REDUCERS_DAILY=1
REQUEST_NUM_REDUCERS_DAILY=1

STORAGE_NUM_REDUCERS_MONTHLY=1
REQUEST_NUM_REDUCERS_MONTHLY=1
